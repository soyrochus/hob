...
Define the user-mode avatar panel behavior, including sound-reactive overlays driven by AI output audio, agent-based configuration, and fallback handling.
